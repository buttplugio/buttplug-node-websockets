 ...
 * application.
 */
class ButtplugNodeWebsocketServer extends buttplug_1.ButtplugServer {
    constructor(name, maxPingTime = 0) {
         ...
         */
        this.StartInsecureServer = (port = 12345, host = "localhost") => {
         ...
         * @param host Host address to listen on (defaults to localhost)
         */
        this.StartSecureServer = (certFilePath, keyFilePath, port = 12345, host = "localhost") => {
            const pems = {};
        ...
        this.InitServer = () => {
            ...
            this.wsServer.on("connection", function connection(client) {
                client.on("message", (message) => __awaiter(this, void 0, void 0, function* () {
                    const msg = buttplug_1.FromJSON(message);
                    for (const m of msg) {
